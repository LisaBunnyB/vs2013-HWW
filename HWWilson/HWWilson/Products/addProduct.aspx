<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="addProduct.aspx.cs" Inherits="HWWilson.addProduct" %>
   ...
   <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter the products name" ControlToValidate="TextProdName" CssClass="ErrorMsg" ForeColor="Red"></asp:RequiredFieldValidator><br />       
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please enter a barcode for the product" ControlToValidate="TextProdBarcode" CssClass="ErrorMsg" ForeColor="Red"></asp:RequiredFieldValidator><br />
   ...
   <asp:Label ID="LblProdMinLevel" width="150" runat="server" Text="Minimum stock level"></asp:Label>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please enter a stock code for the product" ControlToValidate="TextProdStockCode" CssClass="ErrorMsg" ForeColor="Red"></asp:RequiredFieldValidator><br /><br />
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Please select a category ID for the product" ControlToValidate="DDLProdCat" CssClass="ErrorMsg" ForeColor="Red"></asp:RequiredFieldValidator><br /><br />
